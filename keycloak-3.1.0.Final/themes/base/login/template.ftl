...
<div class="col-md-4" style="text-align:center;color:white;">
    <div id="kc-logo"><div id="collegelogo" ></div> </div> <div  id="kc-header-wrapper" style="font-size:1.85em;" ></div>
</div>
...
<div>
      ...
      <div class="row footer hidden-sm hidden-xs">
                ...
                <div class="col-md-4 col-sm-4">
                  ...
                  <a style="color:#fff;" target="_blank" href={{util.APP_LINK}}><span class="footer-img playstore-icon">&nbsp;</span>
                  </a>
          ...
          <div class="col-md-offset-1 col-md-3  text-center">
              <p class="login-footer-font "> <span class="footer-img spaneos-icon">&nbsp;</span>
              </p>
          </div>
